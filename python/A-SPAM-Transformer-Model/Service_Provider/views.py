...
def View_SMSMessage_Type_Ratio(request):
    ...
    kword1 = 'Ham'
    print(kword1)
    obj1 = aspam_transformer_prediction.objects.all().filter(Q(Prediction = kword))
    ...
    return render(request, 'SProvider/View_SMSMessage_Type_Ratio.html', {'obj': obj})
...
def likeschart(request, like_chart):
    ...
    return render(request, "SProvider/likechart.html", {'form' : charts, 'like_chart' : like_chart})
